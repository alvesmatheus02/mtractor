...
public class acaoDesmarcaExpedido implements AcaoRotinaJava {
    ...
    public void doAction(ContextoAcao contexto) throws Exception {
        ...
        for(Registro linha : linhas) {
            ...
            cabDAO.prepareToUpdate(cabVO)
                    .set("AD_EXPEDIDO", null)
                    .set("AD_DHEXPEDICAO", null)
                    .set("AD_CODUSUEXPE", null)
                    .update();
        }

        contexto.setMensagemRetorno("Pedido(s) desmarcado(s) como expedido(s).");
